...
<div class="form-group">
            <label for="bd">弯矩标准值(KN·m)</label>
            <input type="number" id="bd" name="bd" placeholder="600" required>
</div>
<div class="form-group">
            <label for="dm">围护桩直径(mm)</label>
...
<div class="form-group">
            ...
            <div class="form-group">
            <label for="tk">混凝土保护层(mm)</label>
            <input type="number" id="tk" name="tk" placeholder="70" required>
</div>
<div class="form-group">
