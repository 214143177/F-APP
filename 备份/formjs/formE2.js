...
<div class="form-group">
            ...
            <input type="number" id="t" name="t" placeholder="20" required>
            </div>
<div class="form-group">
...
<div class="form-group">
            <label for="fa">钢材抗压强度设计值(N/mm²)</label>
            <input type="number" id="fa" name="fa" placeholder="215" required>
            </div>
<div class="form-group">
            <label for="N">轴向压力设计值(KN)</label>
            <input type="number" id="N" name="N" placeholder="16000" required>
            </div>
<div class="form-group">
            <label for="M1">柱顶弯设计值(KN·m)</label>
            <input type="number" id="M1" name="M1" placeholder="320" required>
            </div>
<div class="form-group">
            <label for="M2">柱底弯设计值(KN·m)</label>
            <input type="number" id="M2" name="M2" placeholder="320" required>
