...
<div class="form-group">
            <label for="b">框架柱宽度(mm)</label>
            <input type="number" id="b" name="b" placeholder="1000" required>
        </div>
<div class="form-group">
            <label for="h">框架柱高度(mm)</label>
...
<div class="form-group">
            <label for="Nb">轴力标准值(KN)</label>
            <input type="number" id="Nb" name="Nb" placeholder="10000" required>
        </div>
<div class="form-group">
            <label for="fc">混凝土标号(N/mm²)</label>
...
<div class="form-group">
            <label for="rv">最小配箍特征值(查表)</label>
            <input type="number" id="rv" name="rv" placeholder="0.13" required>
        </div>
<div class="form-group">
            <label for="fai">箍筋直径(mm)</label>
            <input type="number" id="fai" name="fai" placeholder="14" required>
        </div>
<div class="form-group">
            <label for="sp">箍筋间距(mm)</label>
            <input type="number" id="sp" name="sp" placeholder="100" required>
        </div>
<div class="form-group">
            <label for="ls">箍筋总长(mm)</label>
            <input type="number" id="ls" name="ls" placeholder="10000" required>
            <input type="checkbox" id="Qg" name="Qg">全高配箍
            </div>
<div class="form-group">
            <label for="gj">纵筋直径(mm)</label>
            <input type="number" id="gj" name="gj" placeholder="25" required>
        </div>
<div class="form-group">
            <label for="Qud">全部纵筋配筋率-设计值(%)</label>
            <input type="number" id="Qud" name="Qud" placeholder="0.9" required>
        </div>
<div class="form-group">
            <label for="Qs">全部纵筋数量(根)</label>
            <input type="number" id="Qs" name="Qs" placeholder="24" required>
        </div>
<div class="form-group">
            <label for="Dud">单边纵筋配筋率-设计值(%)</label>
            <input type="number" id="Dud" name="Dud" placeholder="0.2" required>
        </div>
<div class="form-group">
            <label for="Ds">单边纵筋数量(根)</label>
            <input type="number" id="Ds" name="Ds" placeholder="12" required>
        </div>
