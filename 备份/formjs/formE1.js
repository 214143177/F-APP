function formE1() {
    ...
    <div class="picture">
            <img src="../image/双筋矩形受弯承载力1.png" alt="双筋矩形受弯承载力">
            <img src="../image/双筋矩形受弯承载力2.png" alt="双筋矩形受弯承载力">
        </div>`;
    document.getElementById("forms").innerHTML = `
        <form id="formE1" class="form">
            <h1>双筋矩形正截面受弯承载力</h1>
            <div class="form-group">
                <label>弯矩设计值(KN·m)</label>
                <input type="number" id="M" name="M" placeholder="1000" required>
            </div>
            <div class="form-group">
                <label>矩形宽度(mm)</label>
            ...
            <div class="form-group">
                <label>预估主筋直径(mm)</label>
                <input type="number" id="D" name="D" placeholder="25" required>
            </div>
            <div class="form-group">
                <label>预估箍筋直径(mm)</label>
                <input type="number" id="d" name="d" placeholder="14" required>
            </div>
            <div class="form-group">
                <label>最外层净保护层厚度(mm)</label>
                <input type="number" id="c" name="c" placeholder="40" required>
            </div>
            <div class="form-group">
                <label>混凝土标号</label>
