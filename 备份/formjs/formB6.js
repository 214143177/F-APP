function formB6() {
    ...
    document.getElementById("forms").innerHTML = `
        ...
        <div class="form-group">
            <label for="b">截面宽度(mm)</label>
            <input type="number" id="b" name="b" placeholder="800" required>
        </div>
<div class="form-group">
            <label for="h">截面高度(mm)</label>
            <input type="number" id="h" name="h" placeholder="1000" required>
        </div>
<div class="form-group">
            <label for="Tk">拉力标准值(KN)</label>
            <input type="number" id="Tk" name="Tk" placeholder="2000" required>
        </div>
<div class="form-group">
            <label for="Mk">弯矩标准值(KN·m)</label>
            <input type="number" id="Mk" name="Mk" placeholder="2000" required>
        </div>
<div class="form-group">
            <label for="Dt">受拉钢筋直径(mm)</label>
...
<div class="form-group">
            <label for="Nt">受拉钢筋数量(根)</label>
            <input type="number" id="Nt" name="Nt" placeholder="20" required>
        </div>
<div class="form-group">
            <label for="Dc">受压钢筋直径(mm)</label>
...
<div class="form-group">
            <label for="Nc">受压钢筋数量(根)</label>
            <input type="number" id="Nc" name="Nc" placeholder="20" required>
        </div>
<div class="form-group">
            <label for="Es">钢筋弹性模量(N/mm²)</label>
            <input type="number" id="Es" name="Es" placeholder="200000" required>
        </div>
<div class="form-group">
            <label for="v">钢筋相对粘结特性系数</label>
            <input type="number" id="v" name="v" placeholder="1" required>
        </div>
<div class="form-group">
            <label for="acr">构件受力特征系数</label>
            <input type="number" id="acr" name="acr" placeholder="2.4" required>
        </div>
<div class="form-group">
            <label for="fc">混凝土抗压强度(N/mm²)</label>
...
<div class="form-group">
            <label for="a">保护层厚度(mm)</label>
            <input type="number" id="a" name="a" placeholder="70" required>
        </div>
